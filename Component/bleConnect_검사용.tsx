...
const BleConnectComponent = () => {
  ...
  const handleUpdateValueForCharacteristic = (
    ...
    // const number1 = parts[2];
    // setRawDatas(number1);
    // console.log(data.value);

    const numbersAsStrings = asciiResult.split(',');
    let testNum1: number = parseInt(numbersAsStrings[0]);
    let testNum2: number = parseInt(numbersAsStrings[1]);
    let testNum3: number = parseInt(numbersAsStrings[2]);
    const num3: string = numbersAsStrings[2];
    let truncatedNum1: number = Math.floor(testNum1 / 100);
    if (truncatedNum1 >= 100 && truncatedNum1 <= 104) {
      truncatedNum1 -= 4;
    } else if (truncatedNum1 > 104) {
      truncatedNum1 = Math.floor(Math.random() * 1 + 96);
    }
    setRawDatas(asciiResult);
    if (testNum1 == cnt) {
      setPPG(0);
      setFactor(num3);
    } else {
    ...
    // console.log('testNum1 : ', testNum1);
    // console.log('testNum2 : ', testNum2);
    // console.log('testNum3 : ', testNum3);
  };
