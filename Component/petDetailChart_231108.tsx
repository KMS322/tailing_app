...
const PetDetailComponent = () => {
  ...
  const handleUpdateValueForCharacteristic = (
    ...
    if (data.value) {
      ...
      const truncatedNum1: number = Math.floor(num1 / 100);
      const truncatedNum2: number = Math.round((num2 / 100) * 20);
      const num3: number = parseInt(numbersAsStrings[2]);
      setDatas(prev => ({
        ...prev,
        connectState: 1,
        healthDatas: [
          {...prev.healthDatas[0], data: truncatedNum2}, // bpm
          {...prev.healthDatas[1], data: 0}, // rpm
          {...prev.healthDatas[2], data: 38}, // temp
          {...prev.healthDatas[3], data: truncatedNum1}, //spo2
        ],
      }));
    }
  };
